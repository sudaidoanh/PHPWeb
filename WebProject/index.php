            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-heading">
                        ...
                        <a href="products.php">Tất cả khuyến mãi <i class="fa fa-angle-right"></i></a>
                    </div>
                </div>
                <?php
                    $p->loadKhuyenMai("Select * from product order by khuyenMai desc limit 5")
                ?>
            </div>

            <?php
                $p->loadComboSP("select * from company order by company_name asc");
            ?>
